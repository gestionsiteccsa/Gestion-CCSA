    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_login",
                    models.DateTimeField(blank=True, null=True, verbose_name="dernière connexion"),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timestamp",
                    models.DateTimeField(auto_now_add=True, verbose_name="date et heure"),
                ),
                (
                    "ip_address",
                ...
                (
                    "failure_reason",
                    models.CharField(blank=True, max_length=100, verbose_name="raison de l'échec"),
                ),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bio",
                    models.TextField(blank=True, max_length=500, verbose_name="biographie"),
                ),
                (
                    "birth_date",
                ...
                (
                    "location",
                    models.CharField(blank=True, max_length=100, verbose_name="localisation"),
                ),
                (
                    "notification_enabled",
                    models.BooleanField(default=True, verbose_name="notifications activées"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "session_key",
                    models.CharField(max_length=40, unique=True, verbose_name="clé de session"),
                ),
                (
                    "ip_address",
                    models.GenericIPAddressField(blank=True, null=True, verbose_name="adresse IP"),
                ...
                (
                    "last_activity",
                    models.DateTimeField(auto_now=True, verbose_name="dernière activité"),
                ),
                (
                    "user",
                    models.ForeignKey(
