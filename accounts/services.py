...
class NotificationService:
    ...
    @staticmethod
    def notify_user(user, notification_type, title, message, event=None,
                    video_request=None, link='', send_email=True):
        """
        ...
        if send_email and UserNotificationPreference.is_notification_allowed(user, notification_type, 'email'):
    ...
    def _send_email_notification(user, notification_type, title, message, event=None, link=''):
        ...
        try:
            ...
            context = {
                ...
                'message': message,
                'notification_type': notification_type,
                'notification_label': NotificationService.NOTIFICATION_LABELS.get(notification_type, 'Notification'),
                'link': link,
    ...
    @staticmethod
    def notify_communication_team(notification_type, title, message, event=None,
                                   video_request=None, link='', send_email=True):
        """
        ...
        communication_users = User.objects.filter(
            user_roles__role__name='Communication',
