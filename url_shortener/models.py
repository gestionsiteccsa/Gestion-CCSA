...
class ShortenedURL(models.Model):
    ...
    def clean(self):
        ...
        if self.original_url:
            ...
            current_domain = getattr(settings, 'ALLOWED_HOSTS', ['localhost'])[0] if settings.ALLOWED_HOSTS else 'localhost'
    ...
    def get_short_url(self):
        ...
        try:
            ...
            domain = getattr(settings, 'ALLOWED_HOSTS', ['localhost'])[0] if settings.ALLOWED_HOSTS else 'localhost'
