...
class BackupConfigurationAdmin(admin.ModelAdmin):
    ...
    list_display = ['name', 'backup_type', 'frequency', 'is_active', 'keep_last_n', 'updated_at']
...
class BackupHistoryAdmin(admin.ModelAdmin):
    ...
    list_display = ['started_at', 'backup_type', 'trigger', 'status', 'get_file_size_display', 'get_duration', 'created_by']
    list_filter = ['status', 'backup_type', 'trigger']
    readonly_fields = ['started_at', 'completed_at', 'file_size', 'get_file_size_display', 'get_duration']
    ...
    fieldsets = (
        ...
        ('Fichier', {
            'fields': ('file_path', 'file_size', 'get_file_size_display')
        }),
        ('Timing', {
