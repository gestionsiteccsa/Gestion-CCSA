...
class Event(models.Model):
    ...
    notify_on_publish = models.BooleanField(
        default=False, verbose_name="Recevoir un email lors de la confirmation de la publication"
    )
...
class EventDocument(models.Model):
    ...
    document_type = models.CharField(
        max_length=20, choices=DOCUMENT_TYPES, verbose_name="Type de document", blank=True
    )
...
class EventRecurrence(models.Model):
    ...
    recurrence_type = models.CharField(
        max_length=20, choices=RECURRENCE_TYPES, verbose_name="Type de récurrence", default="weekly"
    )
    interval = models.PositiveIntegerField(
        default=1, verbose_name="Intervalle", help_text="Tous les X jours/semaines/mois/années"
    )
